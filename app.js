document.getElementById('currentDay').innerHTML = `<p>${moment().format('[Today is] dddd MMMM Do YYYY')}</p>`
document.getElementById('currentTime').innerHTML = `<p>${moment().format('LT [PST]')}</p>`
